    ...
    >
      <div className="flex items-center ">
        <div className="flex justify-start items-center">
          <Avatar className="ml-12 h-16 w-16" alt="avatar" src={avatar} />
          <div className="flex-row">
            <p className="ml-3 text-white text-xs">by Tran Thai </p>
            <p className="mt-1 ml-3 text-white text-xs">2020 </p>
          </div>
        </div>
        <div className="flex justify-center items-center">
          <h2 className="pt-16 ml-64 pl-32 text-5xl font-mono font-bold italic text-white text-center hover:text-red-100">
            Finding Treasures
          </h2>
        </div>
      </div>
